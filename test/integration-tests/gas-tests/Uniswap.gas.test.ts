...
import { CurrencyAmount, Ether, Percent, Token, TradeType } from '@kinetix/sdk-core'
import { Route as V2RouteSDK, Pair } from '@kinetix/v2-sdk'
import { Route as V3RouteSDK, FeeAmount } from '@kinetix/v3-sdk'
import { SwapRouter, Trade } from '@kinetix/router-sdk'
